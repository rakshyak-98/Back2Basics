...
- **“Fix” TCP churn with epoll tuning** — [[connection churn]] is keepalive/LB/TIME_WAIT policy, not epoll flags.

## Related

[[ss]] [[half-open connections]] [[connection churn]] [[process]] [[Linux network commands]]
