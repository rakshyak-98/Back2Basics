...
> buffer — temporary storage location in memory used to hold data while it's being transferred between two location or processes that operate at different speeds or different data
