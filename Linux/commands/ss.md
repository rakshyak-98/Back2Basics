[[Linux network commands]] [[half-open connections]] [[Epoll]] [[connection churn]]
...
| `TIME-WAIT` | Local side closed cleanly | Storm → ephemeral port exhaustion ([[connection churn]]) |
...
| `TIME-WAIT` thousands | `ss -s`; `ss -tan state time-wait \| wc -l` | [[connection churn]] — keepalive, reuse, tune `ip_local_port_range` |
...
[[Linux network commands]] [[half-open connections]] [[Epoll]] [[connection churn]] [[eBPF]]
