...
- **Note:** Sign: private key creates signature → public key verifies (not decrypt messag…
```
...
- **Note:** Algorithms: **RSA**, **ECDSA**, **Ed25519** (sign), **ECIES** (encrypt). Hybr…


- **Core:** Asymmetric (public-key) cryptography uses a key pair: the public key encrypts…
...
## Mistakes to Avoid
- **Mistake:** Encrypting with private key is NOT signing
- **Mistake:** Private key in repo — use KMS/HSM — see [[KMS]]
- **Mistake:** RSA 1024 deprecated — minimum 2048, prefer 4096 or Ed25519
...
## Comparison
- vs [[symmetrical encryption]]: public/private pair vs one shared secret
- vs [[HMAC (Hash based Message Authentication Codes)]]: HMAC needs a shared secret


### Use cases
- TLS certificates, SSH host keys, code signing, and JWT RS256/ES256 all rely o…
