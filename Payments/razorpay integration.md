...
## Recall Cues
- Why do interviewers care about Interviewers look for the Order → Checkout → HMAC signature verify → webhook safety-net pattern, and why browser-returned fields alone are forgeable?
- What is step 1: User clicks Pay?
- What is step 2: Frontend → Backend: create Order?
- What is step 3: Backend → Razorpay Orders API → order_id (save Pending)?
- What is step 4: Frontend opens Checkout with order_id?
- What is step 5: User pays in Razorpay UI?
- What is step 6: Frontend receives payment_id + signature?
- What is step 7: Backend verifies HMAC; mark Paid?
