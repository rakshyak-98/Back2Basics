...
## Recall Cues
- Why do interviewers care about the challenge-sign-verify story, not “SSH uses keys,” plus why the server decides which methods are allowed?
- What is step 1: Client offers a public key?
- What mistake is **Sharing one private key across users or machines**?
- What mistake is **Assuming the client can override server-disabled publickey**?
- What mistake is **Ignoring algorithm mismatches between new clients and old `sshd`**?
