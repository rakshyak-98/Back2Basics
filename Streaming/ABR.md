...
> ABR — adaptive Bit Rate — A streaming technique where the video quality automatically changes based on the viewer's current network speed, device capability, and buffer state.
