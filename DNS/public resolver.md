...
## Key Concepts
- **Recursive only:** they cache answers from authoritative [[name server]]s
- **Policy variants:** malware blocking (Quad9), family filters, logging policies differ by operator.
- **Encrypted transport:** DoH/DoT hide queries on the path to the resolver
...
- Corporate networks may **block** alternate resolvers
...
## Mistakes to Avoid
- **Mistake:** Pointing production servers at a public resolver and expecting V…
- **Mistake:** Assuming DoH means “nobody sees my queries”
- **Mistake:** Ignoring enterprise policy that blocks or redirects alternate re…
...
## Comparison
- vs authoritative [[name server]]: public resolvers do not publish your MX/A records for the world…
- vs self-hosted [[Unbound]]: you keep cache and forwarding policy on-box


### Use cases
- Traveling laptops, CI runners, and home networks often pin a public resolver …

- **Example:** Office Wi-Fi hijacks DNS to a captive portal
