...
**Say it in one breath:** flutter debugging — plain job, how I run it, how I know it’s broken.
...
|------|---------------|------------------|
| **flutter debugging** | Core idea of this note | “I can explain flutter debugging without jargon.” |
