...
## Folder clusters (top-level domains)

### Operating System (69 notes)
...
### Descriptive/JavaScript (18 notes)
...
### Linux/management (14 notes)

- [[ELF (Editabl Linkable File)]]
...
- [[data visualization]]
- [[feature importance]]
- [[predicated vs actual plot]]

### MongoDB/mongoose (5 notes)
...
### Data structure/algo (3 notes)

- [[Two pointer]]
- [[binary search]]
- [[greedy algorithm]]

### Database/SQL (3 notes)

- [[SQL error]]
- [[SQL]]
- [[postgres]]

### Feature implementation (3 notes)

- [[Bar code generate feature]]
- [[Manage cart with session id]]
- [[Push notification integration]]

### LLD/Questions (3 notes)

- [[Connection Pool]]
- [[File based configuration manager]]
- [[Logger]]

### Linux/services (3 notes)
...
### Nginx/Configuration (3 notes)

- [[nginx auto file configuration]]
- [[nginx stream]]
- [[nginx using unix socket]]

### Operating System/Boot (3 notes)

- [[Extensible Firmware interface (efi)]]
- [[UEFI (2)]]
- [[UEFI]]

### React/Redux/RTQ (3 notes)
...
### Architectures/database (2 notes)

- [[MVCC]]
- [[OCC]]

### Design pattern/Creation pattern (2 notes)
...
### MongoDB/query (2 notes)

- [[mongoDB Group query]]
- [[mongodb lookup query]]

### NodeJS/Stream (2 notes)
...
### Programming paradigram (2 notes)
...
## Likely duplicate pairs (review first)
...
| 0.882 | [[apt package manager]] | [[Package Manager]] | string |
| 0.878 | [[mysql pool connection]] | [[mysql ssl connection]] | token+string |
| 0.872 | [[mongoDB Group query]] | [[mongodb lookup query]] | token+string |
| 0.865 | [[mysql connection]] | [[mysql pool connection]] | token+string |
| 0.857 | [[mysql table]] | [[psql table]] | token+string |
| 0.857 | [[express error handler]] | [[express query handler]] | token+string |
| 0.842 | [[Encoding]] | [[re-encoding]] | token+string |
| 0.837 | [[binary classification]] | [[ordinal classification]] | token+string |
| 0.833 | [[Clean Architecture]] | [[React Architecture]] | token+string |
| 0.828 | [[mongodb schema]] | [[mongoose schema]] | token+string |
| 0.824 | [[Clean Architecture]] | [[HES Architecture]] | token+string |
| 0.824 | [[React Architecture]] | [[HES Architecture]] | token+string |
| 0.821 | [[typescript extend types]] | [[typescript types]] | token+string |
| 0.818 | [[Stack Frame]] | [[Stack trace]] | token+string |
...
## Title similarity groups (possible duplicates)
...
### `mysql partitioning`
- `Database/mysql/mysql partitioning.md`
- `Database/mysql partitioning.md`

### `mysql triggers`
- `Database/mysql/MySQL Triggers.md`
- `Database/mysql/mysql triggers.md`
...
### `systemctl`
- `Linux/commands/systemctl.md`
- `Linux/management/systemctl.md`
